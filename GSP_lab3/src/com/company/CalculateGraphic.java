...
public class CalculateGraphic {
    ...
    public static ArrayList<Node> makeEdge(int n, int[][] matrix, MyNode[] nodes, boolean orientation) {
            ...
            for (int j = 0; j < a[i].length; j++){
                if (orientation) {
                    if (a[i][j] == 1 && a[j][i] == 1 && i!=j) {
                        ...
                        edgeList.add(makeNoLoopEdge(n, nodes[i], nodes[j], true));
                        edgeList.add(makeNoLoopEdge(n, nodes[j], nodes[i], true));
                    ...
                    if (a[i][j] == 1 && a[j][i] == 1 && i == j) {
                        ...
                        if (a[i][j] == 1 && a[j][i] == 1) {
                            edgeList.add(makeNoLoopEdge(n, nodes[i], nodes[j], false));
                            a[i][j] = -1;
                            a[j][i] = -1;
                        }
                    }
    ...
    public static Node makeLoopEdge(MyNode node) {
    ...
    public static Node makeNoLoopEdge(int n, MyNode ot, MyNode ku, boolean flag) {
    ...
    public static double[] lineCircleIntersection(double k, double b, double otX, double otY, double kuX, double kuY, double r) {
    ...
    public static double[] findControlXY(MyNode ot, MyNode ku) {
    ...
    public static double[] findControlXYoriented(MyNode ot, MyNode ku) {
        double x01 = ot.circle.getCenterX();
        double y01 = ot.circle.getCenterY();
        double x02 = ku.circle.getCenterX();
        double y02 = ku.circle.getCenterY();
        ...
        if (k == 0) {
            return new double[]{(x01+x02)/2, y01+80};
        } else {
            k = -1 / k;
    ...
    public static double lenOfLine(double x1, double y1, double x2, double y2) {
